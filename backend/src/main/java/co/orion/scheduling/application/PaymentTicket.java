 ...
 *
 * {@code checkoutUrl} es null cuando no hay nada que cobrar (el crédito cubrió la clase entera):
 * en ese caso la reserva ya nace confirmada y no hay pasarela de por medio.
 *
...
public record PaymentTicket(UUID paymentId,
    ...
    public boolean fullyCoveredByCredit() {
        return chargedCop == 0;
    }
}
