...
/**
 * Lo que hay que pagar por una reserva recién creada. {@code checkoutUrl} es null cuando el crédito
 * cubrió la clase entera: en ese caso la reserva ya nace confirmada y no hay a dónde ir a pagar.
 *
