# Pedidos de Pardo por chat

Un archivo por mensaje, con el pedido tal cual, el resumen en historias de usuario y features, y su
estado. La regla está en `CLAUDE.md` → «Registro de pedidos». Del más reciente al más viejo:
