...
/**
 * Landing pública por idioma. Ruta pública (fuera del grupo autenticado): cualquiera puede llegar
 * desde SEO o campañas. Resuelve el nombre del idioma del catálogo y muestra hasta 4 profesores
 * reales, con un CTA que lleva al buscador ya filtrado. Datos honestos: sin ratings ni inventos.
 */
export default function IdiomaLandingPage() {
  ...
  const profesores = useQuery({
    ...
    queryFn: () =>
      apiFetch<PagedProfessors>(`/api/v1/professors?language=${codigo}&size=4`),
  });
